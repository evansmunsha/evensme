    ...
    <SessionProvider value={session}>
      <div className="flex min-h-screen flex-col">
        ...
        <div className="mx-auto flex w-full max-w-7xl grow gap-3 sm:p-5">
          <div className="flex-col gap-2 bg-red-700">
           ...
           <SubscribeForm  className="sticky top-[5.25rem] hidden h-fit flex-col space-y-3 rounded bg-card px-1 py-2 shadow-sm sm:block lg:px-5 xl:w-80 z-50 "/>
          </div>
